...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Action_Execution)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Action_Mount)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Action_GripSwitch)
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Window_Execution)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Window_Mount)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Window_GripSwitch)
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Window_Locomotion)
